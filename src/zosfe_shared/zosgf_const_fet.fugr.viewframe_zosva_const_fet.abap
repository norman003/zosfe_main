*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONST_FET
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONST_FET     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FET'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONST_FET_EXTRACT
TOTAL = ZOSVA_CONST_FET_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FET'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONST_FET-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONST_FET_EXTRACT
TOTAL = ZOSVA_CONST_FET_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONST_FET-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FET'
...
TOTAL = ZOSVA_CONST_FET_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONST_FET-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONST_FET-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FET'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONST_FET-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONST_FET_EXTRACT
TOTAL = ZOSVA_CONST_FET_TOTAL
