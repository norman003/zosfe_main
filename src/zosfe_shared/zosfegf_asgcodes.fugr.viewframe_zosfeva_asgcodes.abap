*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSFEVA_ASGCODES
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSFEVA_ASGCODES    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSFEVA_ASGCODES'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSFEVA_ASGCODES_EXTRACT
TOTAL = ZOSFEVA_ASGCODES_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_ASGCODES'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSFEVA_ASGCODES-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_ASGCODES_EXTRACT
TOTAL = ZOSFEVA_ASGCODES_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSFEVA_ASGCODES-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSFEVA_ASGCODES'
...
TOTAL = ZOSFEVA_ASGCODES_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSFEVA_ASGCODES-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSFEVA_ASGCODES-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_ASGCODES'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSFEVA_ASGCODES-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_ASGCODES_EXTRACT
TOTAL = ZOSFEVA_ASGCODES_TOTAL
