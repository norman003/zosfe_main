*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONST_FE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONST_FE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONST_FE_EXTRACT
TOTAL = ZOSVA_CONST_FE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONST_FE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONST_FE_EXTRACT
TOTAL = ZOSVA_CONST_FE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONST_FE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FE'
...
TOTAL = ZOSVA_CONST_FE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONST_FE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONST_FE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONST_FE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONST_FE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONST_FE_EXTRACT
TOTAL = ZOSVA_CONST_FE_TOTAL
