*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONSTAUART
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONSTAUART    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAUART'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONSTAUART_EXTRACT
TOTAL = ZOSVA_CONSTAUART_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAUART'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONSTAUART-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTAUART_EXTRACT
TOTAL = ZOSVA_CONSTAUART_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONSTAUART-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAUART'
...
TOTAL = ZOSVA_CONSTAUART_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONSTAUART-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONSTAUART-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAUART'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONSTAUART-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTAUART_EXTRACT
TOTAL = ZOSVA_CONSTAUART_TOTAL
