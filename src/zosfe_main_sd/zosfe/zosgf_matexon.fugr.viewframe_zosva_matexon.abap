*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_MATEXON
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_MATEXON       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_MATEXON'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_MATEXON_EXTRACT
TOTAL = ZOSVA_MATEXON_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_MATEXON'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_MATEXON-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_MATEXON_EXTRACT
TOTAL = ZOSVA_MATEXON_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_MATEXON-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_MATEXON'
...
TOTAL = ZOSVA_MATEXON_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_MATEXON-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_MATEXON-UPD_FLAG NE SPACE.
