*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONSTAKONV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONSTAKONV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAKONV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONSTAKONV_EXTRACT
TOTAL = ZOSVA_CONSTAKONV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAKONV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONSTAKONV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTAKONV_EXTRACT
TOTAL = ZOSVA_CONSTAKONV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONSTAKONV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAKONV'
...
TOTAL = ZOSVA_CONSTAKONV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONSTAKONV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONSTAKONV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTAKONV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONSTAKONV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTAKONV_EXTRACT
TOTAL = ZOSVA_CONSTAKONV_TOTAL
