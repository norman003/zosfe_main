*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSFEVA_DOCUINAC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSFEVA_DOCUINAC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSFEVA_DOCUINAC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSFEVA_DOCUINAC_EXTRACT
TOTAL = ZOSFEVA_DOCUINAC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_DOCUINAC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSFEVA_DOCUINAC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_DOCUINAC_EXTRACT
TOTAL = ZOSFEVA_DOCUINAC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSFEVA_DOCUINAC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSFEVA_DOCUINAC'
...
TOTAL = ZOSFEVA_DOCUINAC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSFEVA_DOCUINAC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSFEVA_DOCUINAC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_DOCUINAC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSFEVA_DOCUINAC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_DOCUINAC_EXTRACT
TOTAL = ZOSFEVA_DOCUINAC_TOTAL
