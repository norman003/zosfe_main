*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CATALOGO18
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CATALOGO18    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO18'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CATALOGO18_EXTRACT
TOTAL = ZOSVA_CATALOGO18_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO18'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CATALOGO18-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CATALOGO18_EXTRACT
TOTAL = ZOSVA_CATALOGO18_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CATALOGO18-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO18'
...
TOTAL = ZOSVA_CATALOGO18_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CATALOGO18-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CATALOGO18-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO18'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CATALOGO18-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CATALOGO18_EXTRACT
TOTAL = ZOSVA_CATALOGO18_TOTAL
