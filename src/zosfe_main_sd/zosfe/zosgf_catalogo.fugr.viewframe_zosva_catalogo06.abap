*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CATALOGO06
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CATALOGO06    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO06'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CATALOGO06_EXTRACT
TOTAL = ZOSVA_CATALOGO06_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO06'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CATALOGO06-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CATALOGO06_EXTRACT
TOTAL = ZOSVA_CATALOGO06_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CATALOGO06-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO06'
...
TOTAL = ZOSVA_CATALOGO06_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CATALOGO06-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CATALOGO06-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CATALOGO06'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CATALOGO06-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CATALOGO06_EXTRACT
TOTAL = ZOSVA_CATALOGO06_TOTAL
