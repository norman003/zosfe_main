*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONSEXTSUN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONSEXTSUN    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSEXTSUN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONSEXTSUN_EXTRACT
TOTAL = ZOSVA_CONSEXTSUN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSEXTSUN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONSEXTSUN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSEXTSUN_EXTRACT
TOTAL = ZOSVA_CONSEXTSUN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONSEXTSUN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSEXTSUN'
...
TOTAL = ZOSVA_CONSEXTSUN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONSEXTSUN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONSEXTSUN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSEXTSUN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONSEXTSUN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSEXTSUN_EXTRACT
TOTAL = ZOSVA_CONSEXTSUN_TOTAL
