*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSFEVA_CATACONS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSFEVA_CATACONS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSFEVA_CATACONS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSFEVA_CATACONS_EXTRACT
TOTAL = ZOSFEVA_CATACONS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_CATACONS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSFEVA_CATACONS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_CATACONS_EXTRACT
TOTAL = ZOSFEVA_CATACONS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSFEVA_CATACONS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSFEVA_CATACONS'
...
TOTAL = ZOSFEVA_CATACONS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSFEVA_CATACONS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSFEVA_CATACONS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSFEVA_CATACONS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSFEVA_CATACONS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSFEVA_CATACONS_EXTRACT
TOTAL = ZOSFEVA_CATACONS_TOTAL
