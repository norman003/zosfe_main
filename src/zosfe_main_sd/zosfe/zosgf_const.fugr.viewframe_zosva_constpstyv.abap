*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_CONSTPSTYV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_CONSTPSTYV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTPSTYV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_CONSTPSTYV_EXTRACT
TOTAL = ZOSVA_CONSTPSTYV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTPSTYV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_CONSTPSTYV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTPSTYV_EXTRACT
TOTAL = ZOSVA_CONSTPSTYV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_CONSTPSTYV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTPSTYV'
...
TOTAL = ZOSVA_CONSTPSTYV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_CONSTPSTYV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_CONSTPSTYV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZOSVA_CONSTPSTYV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZOSVA_CONSTPSTYV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_CONSTPSTYV_EXTRACT
TOTAL = ZOSVA_CONSTPSTYV_TOTAL
