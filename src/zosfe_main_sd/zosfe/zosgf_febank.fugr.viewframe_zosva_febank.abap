*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOSVA_FEBANK
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOSVA_FEBANK        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOSVA_FEBANK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOSVA_FEBANK_EXTRACT
TOTAL = ZOSVA_FEBANK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOSVA_FEBANK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOSVA_FEBANK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOSVA_FEBANK_EXTRACT
TOTAL = ZOSVA_FEBANK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOSVA_FEBANK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOSVA_FEBANK'
...
TOTAL = ZOSVA_FEBANK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOSVA_FEBANK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOSVA_FEBANK-UPD_FLAG NE SPACE.
